...
public class FrontEndGTerm {
	...
	public FrontEndGTerm(BackEnd backEnd) {
		...
		String input = this.gt.getInputString("How many registrations would you like to apply for?");
	...
	public Registration validateInput(String input) {
		...
		return new Registration(record[0], Integer.parseInt(record[1]), record[2].charAt(0), Double.parseDouble(record[3]),
