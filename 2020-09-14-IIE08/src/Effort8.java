...
public class Effort8 {
	...
	// or console.
	public Effort8(int userInterfaceMode) {
    ...
    // This "main" method creates an object instance of the the class Effort8 and uses the 
