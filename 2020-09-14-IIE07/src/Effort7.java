...
public class Effort7 {
	...
	// or console.
	public Effort7(int userInterfaceMode) {
    ...
    // This "main" method creates an object instance of the the class Effort7 and uses the 
